...
describe('c-mini-cart', () => {
    ...
    it('renders cart icon structure', () => {
        ...
        return Promise.resolve().then(() => {
            const cartButton = element.shadowRoot.querySelector('button, lightning-button, .cart-button');
            const cartIcon = element.shadowRoot.querySelector('lightning-icon, .cart-icon, [icon-name]');
            
            // Should have some cart-related UI element
            expect(cartButton || cartIcon || element.shadowRoot.querySelector('div')).toBeTruthy();
        });
    });
    ...
    it('can handle click events', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            const clickableElement = element.shadowRoot.querySelector('button, lightning-button, [onclick]');

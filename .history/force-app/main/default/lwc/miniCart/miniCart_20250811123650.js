...
/**
 * @description Mini Cart component that displays the current cart item count.
 * 
 * This component subscribes to the CartUpdate Lightning Message Service channel
 * to receive real-time updates when items are added to the cart. It automatically
 * refreshes the cart count without requiring a page refresh.
 * 
...
export default class MiniCart extends LightningElement {
     ...
     */
    get isLoading() {
        return !this.wiredCartResult || (!this.wiredCartResult.data && !this.wiredCartResult.error);
    }

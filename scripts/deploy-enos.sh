...
# ENOS Deployment Script
# This script automates the deployment of the ENOS e-commerce solution

echo "🚀 Starting ENOS Deployment..."
echo "======================================"
...
read -p "Enter comma-separated usernames to assign ENOSCommunity: " USER_LIST
IFS=',' read -ra USERS <<< "$USER_LIST"
for USERNAME in "${USERS[@]}"; do
    sfdx force:user:permset:assign -n ENOSCommunity -o "$USERNAME"
done
